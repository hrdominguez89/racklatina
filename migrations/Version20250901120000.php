...
final class Version20250901120000 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE user DROP INDEX UNIQ_IDENTIFIER_NATIONAL_ID_NUMBER');
    }

    public function down(Schema $schema): void
    {
        $this->addSql('ALTER TABLE user ADD UNIQUE KEY UNIQ_IDENTIFIER_NATIONAL_ID_NUMBER (national_id_number)');
    }
}